       ...
       private Color AddColor(float value, float zmin, float zmax)
        ...
        public void AddColorBar(Graphics g, ChartStyle cs, float zmin, float zmax)
        {
            if (cs.IsColorBar)
            {
                ...
                x = 5 * form1.pcbplot.Width / 6;
                y = form1.pcbplot.Height / 15;
                width = form1.pcbplot.Width / 25;
                height = 8 * form1.pcbplot.Height / 15;
        ...
        private PointF Point2D(PointF pt)
        {
            ...
            aPoint.X = form1.pcbplot.Width / 2 + pt.X;
            aPoint.Y = form1.pcbplot.Height / 2 - pt.Y;
            return aPoint;
        }
