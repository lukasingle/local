...
namespace Example8_9_1
{
    ...
    public class DataSeries : ISerializable
    {
        ...
        {
            get { return _mbarStyle; }
            set { _mbarStyle = value; }
        }
        ...
        protected DataSeries(SerializationInfo info, StreamingContext context)
        {
            ...
            _mbarStyle = (BarStyle)info.GetValue("barStyle", typeof(BarStyle));
        ...
        public virtual void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("barStyle", _mbarStyle);
