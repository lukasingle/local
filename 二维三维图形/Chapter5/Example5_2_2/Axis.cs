...
namespace Example5_2_2
{
	...
	#region Class Fields
		...
		/// </summary>
		/// <remarks>
		/// Note that, if you are going to Serialize data, then any type
	...
	#region Events
		...
		/// <returns>
		/// A string value representing the label, or null if the Example5_2_2 should go ahead
	...
	#region Scale Properties
		...
		/// </summary>
		/// <value>Set to true to have Example5_2_2 put the axis in the default location, or false
	...
	#region Rendering Methods
		...
		internal float CalcCrossFraction( GraphPane pane )
		{
            ...
            if (((this is XAxis || this is YAxis) && _scale._isLabelsInside == crossAxis._scale.IsReverse) ||
             (_scale._isLabelsInside != crossAxis._scale.IsReverse))
