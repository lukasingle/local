...
namespace Example5_1_1
{
	...
	#region Events
		...
		/// <returns>
		/// A string value representing the label, or null if the Example5_1_1 should go ahead
	...
	#region Scale Properties
		...
		/// </summary>
		/// <value>Set to true to have Example5_1_1 put the axis in the default location, or false
